<script lang="ts">
	...
	const DEFAULT_PINNED_ITEMS = ['notes', 'workspace', 'hammer', 'brain'];
	...
	const getMenuItemMeta = (id) => {
		const items = {
			...
			hammer: { label: 'Command Center', href: '/hammer', iconType: 'hammer' },
			brain: { label: 'Brain Tree', href: '/brain', iconType: 'brain' }
		};
		return items[id];
	};
