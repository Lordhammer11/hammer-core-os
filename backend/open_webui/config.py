...
if default_prompt_suggestions == []:
    default_prompt_suggestions = [
        {
            'title': ['Build something new', 'start a project with an agent'],
            'content': 'I want to build something new. Help me break it down into a plan and pick the right tools.',
        },
        {
            'title': ['Automate a task', 'set up an agent workflow'],
            'content': 'What repetitive task should I automate first? Help me design an agent workflow for it.',
        },
        {
            'title': ['Research deep dive', 'summarize what I need to know'],
            'content': 'Give me a deep research briefing on a topic of your choice that a builder and tech visionary would find valuable today.',
        },
        {
            'title': ['Code review', 'analyze my codebase'],
            'content': 'Review my code and give me a prioritized list of improvements — security, performance, and readability.',
        },
        {
            'title': ['What should I build next?', 'suggest a project'],
            'content': 'Based on the HaMm3r Agent OS stack, suggest 3 ambitious projects I could build or extend this week.',
        },
        {
            'title': ['Daily briefing', 'what matters today'],
            'content': 'Give me a sharp morning briefing: key tech developments, one bold idea to act on, and one thing to learn today.',
        },
    ]
